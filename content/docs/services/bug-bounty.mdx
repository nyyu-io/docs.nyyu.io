...
<Callout type="info">
Help us make NYYU more secure and earn rewards for your contributions!
</Callout>
...
<Callout type="warn">
The threat level will be determined by NYYU security staff, and NYYU has the sole discretion in deciding whether a report meets the reward criteria.
</Callout>
...
<Tabs items={['Web Module', 'Mobile Module']}>
<Tab value="Web Module">
### Web Module Vulnerabilities

- ⚠️ Problems with business logic that may result in the loss of user assets
- 💳 Payment manipulation
- 🔥 Remote code execution (RCE)
- 🔐 Leakage of sensitive information
- 🛡️ Critical OWASP issues such as XSS, CSRF, SQLi, SSRF, IDOR, and others
- ⚡ Other vulnerabilities that may result in potential loss

</Tab>
<Tab value="Mobile Module">

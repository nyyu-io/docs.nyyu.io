...
description: Admin operation to add geographic restrictions for users
---
...
```graphql
addDisallowedCountry(countryCode: String!): String
```
</div>
...
<div className="space-y-3 my-6">
  <div className="rounded-lg border border-emerald-500/20 bg-card p-4">
    <div className="flex items-start justify-between">
      <div>
        <code className="text-sm font-mono text-emerald-400">countryCode</code>
...
<div className="space-y-4 my-6">
  ...
  <Callout type="warn" title="Compliance">
...
<Cards>
  <Card title="Allow Location" href="/docs/api/user/make-allow-location" />

...
description: Initiate email address change process for user account
---
...
<div className="space-y-3 my-6">
  <div className="rounded-lg border border-emerald-500/20 bg-card p-4">
    <div className="flex items-start justify-between">
      <div>
        <code className="text-sm font-mono text-emerald-400">newEmail</code>
...
<div className="space-y-4 my-6">
  ...
  <Callout type="warn" title="Email Uniqueness">

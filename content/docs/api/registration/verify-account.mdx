...
<div className="space-y-4 my-6">
  <div className="rounded-lg border-l-4 border-indigo-500 bg-indigo-500/10 p-4">
    <h4 className="font-bold text-indigo-700 dark:text-indigo-300 mb-1">⏰ Code Expiry Warning</h4>
  ...
  <div className="rounded-lg border-l-4 border-violet-500 bg-violet-500/10 p-4">
    <h4 className="font-bold text-violet-700 dark:text-violet-300 mb-1">🔄 Easy Resend</h4>
  ...
  <div className="rounded-lg border-l-4 border-purple-500 bg-purple-500/10 p-4">
    <h4 className="font-bold text-purple-700 dark:text-purple-300 mb-1">📧 Email Pre-fill</h4>
  ...
  <div className="rounded-lg border-l-4 border-indigo-500 bg-indigo-500/10 p-4">
    <h4 className="font-bold text-indigo-700 dark:text-indigo-300 mb-1">🎯 Input Validation</h4>
    <p className="text-sm text-indigo-900 dark:text-indigo-200">
  ...
  <div className="rounded-lg border-l-4 border-violet-500 bg-violet-500/10 p-4">
    <h4 className="font-bold text-violet-700 dark:text-violet-300 mb-1">📱 Mobile Optimization</h4>
    <p className="text-sm text-violet-900 dark:text-violet-200">

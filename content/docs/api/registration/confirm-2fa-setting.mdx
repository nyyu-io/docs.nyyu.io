...
<div className="relative overflow-hidden rounded-2xl border bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-600 p-8 shadow-2xl mb-8">
  ...
  <div className="relative">
    ...
    <h1 className="text-4xl font-black text-white mb-3 tracking-tight">Confirm 2FA Setting</h1>
...
<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 my-6">
  ...
  <div className="rounded-lg border border-indigo-500/30 bg-background p-5 shadow-sm hover:shadow-md transition-shadow">
    ...
    <p className="text-sm text-foreground">2FA method being confirmed: <code className="text-xs bg-muted px-1 py-0.5 rounded">app</code>, <code className="text-xs bg-muted px-1 py-0.5 rounded">email</code>, or <code className="text-xs bg-muted px-1 py-0.5 rounded">phone</code></p>
  </div>
...
<div className="grid gap-4 my-6">
  ...
  <div className="rounded-lg border border-orange-500/30 bg-gradient-to-br from-orange-500/10 to-amber-500/5 p-6">
    <div className="flex items-center gap-3 mb-2">
      <span className="text-2xl">📧</span>
      <code className="bg-orange-500/20 text-orange-700 dark:text-orange-300 px-3 py-1 rounded font-mono text-sm">Your account is not verified</code>
    </div>
    <p className="text-sm text-foreground">
...
<div className="space-y-4 my-6">
  <div className="rounded-lg border-l-4 border-blue-500 bg-blue-500/10 p-4">
    <h4 className="font-bold text-blue-700 dark:text-blue-300 mb-1">🔢 Auto-Submit</h4>
  ...
  <div className="rounded-lg border-l-4 border-indigo-500 bg-indigo-500/10 p-4">
    <h4 className="font-bold text-indigo-700 dark:text-indigo-300 mb-1">⏱️ Code Expiration</h4>
  ...
  <div className="rounded-lg border-l-4 border-violet-500 bg-violet-500/10 p-4">
    <h4 className="font-bold text-violet-700 dark:text-violet-300 mb-1">✅ Clear Feedback</h4>
  ...
  <div className="rounded-lg border-l-4 border-blue-500 bg-blue-500/10 p-4">
    <h4 className="font-bold text-blue-700 dark:text-blue-300 mb-1">🔄 Error Handling</h4>
    <p className="text-sm text-blue-900 dark:text-blue-200">
  ...
  <div className="rounded-lg border-l-4 border-indigo-500 bg-indigo-500/10 p-4">
    <h4 className="font-bold text-indigo-700 dark:text-indigo-300 mb-1">💾 Save Backup Codes</h4>
    <p className="text-sm text-indigo-900 dark:text-indigo-200">
  ...
  <div className="rounded-lg border-l-4 border-violet-500 bg-violet-500/10 p-4">
    <h4 className="font-bold text-violet-700 dark:text-violet-300 mb-1">📱 Test Before Activation</h4>
    <p className="text-sm text-violet-900 dark:text-violet-200">

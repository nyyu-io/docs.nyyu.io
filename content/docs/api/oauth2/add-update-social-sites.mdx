...
<div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-500/10 via-teal-500/5 to-background p-8 border border-emerald-500/20 mb-8">
  <div className="relative z-10">
    ...
    <p className="text-xl text-muted-foreground mb-6">
      Configure and manage OAuth2 social login provider registrations in your
      system
    </p>
  </div>
...
<div className="p-5 rounded-lg border border-border bg-muted/30">
  <div className="flex items-center gap-2 mb-2">
    <code className="bg-green-500/20 text-green-500 px-2 py-0.5 rounded font-mono text-sm">
      clientId
    </code>
    <span className="text-xs bg-gray-500/20 text-gray-500 px-2 py-0.5 rounded font-semibold">
      Optional
    </span>
  </div>
  <div className="text-sm">
    <div className="font-semibold mb-1">
      Type: <code className="bg-muted px-1 rounded">String</code>
    </div>
...
<div className="p-5 rounded-lg border border-border bg-muted/30">
  ...
  <div className="text-sm">
    ...
    <div className="text-muted-foreground">
      Template for the redirect URI (e.g.,
...
<div className="p-5 rounded-lg border border-border bg-muted/30">
  ...
  <div className="text-sm">
    ...
    <div className="text-muted-foreground">
      List of permissions requested from the OAuth2 provider (e.g., ["openid",
      "profile", "email"])
    </div>
  </div>
</div>
...
<div className="p-5 rounded-lg border border-border bg-muted/30">
  ...
  <div className="text-sm">
    ...
    <div className="text-muted-foreground">
      Attribute name in the user info response used as the username (e.g.,
      "sub", "email")
    </div>
  </div>
</div>
...
<div className="p-5 rounded-lg border border-green-500/30 bg-green-500/10 my-6">
  ...
  <div className="text-sm text-muted-foreground">
    ...
    <code className="bg-muted px-1 rounded">OAuth2Registration</code> object
...
<div className="mt-8 p-6 rounded-xl border border-emerald-500/30 bg-gradient-to-r from-emerald-500/10 to-teal-500/10">
  <div className="flex items-center gap-3">
    ...
    <div>
      ...
      <div className="text-sm text-muted-foreground">
        Store client secrets securely and never expose them in frontend code.
        Rotate credentials regularly and use environment-specific configurations

...
const isAlgoliaSearchResult = (result) => {
...
const defaultGetSearchResultTitle = (result, query) => {
    ...
    const trimmedContent = removeLeadHeading(result.snippet || '', result.meta?.leadHeading?.value);
...
export const DEFAULT_MARKPROMPT_OPTIONS = {
    ...
    chat: {
        ...
        history: true,
        showCopy: true,
        errorText: () => (_jsx("p", { className: "MarkpromptDefaultError", children: "Sorry, it looks like the bot is having a hard time! Please try again in a few minutes." })),
        avatars: {
            visible: true,
        },
    },
    ...
    integrations: {
        createTicket: {
            enabled: false,
            provider: 'zendesk',
            prompt: 'I want to create a support case. Please summarize the conversation so far for sending it to a support agent. Return only the summary itself without assistant commentary. Use short paragraphs. Include relevant code snippets.',
            ...
            form: {
                ...
                maxFileSizeError: 'Total file size is too large to upload. Maximum allowed size is 4.5MB.',
            },
            chat: {
                title: 'Get help',
                ...
                disclaimerView: {
                    message: 'Answers generated with AI. Consider checking important information.',
                },
            },
        },
    },

import { type AlgoliaDocSearchHit, type FileSectionReference, type PromptFeedback, type SearchResult, type SubmitFeedbackOptions, type SubmitSearchQueryOptions } from '@markprompt/core';
import type { ComponentPropsWithRef, ComponentPropsWithoutRef, ComponentType, ElementType, PropsWithChildren, ReactNode } from 'react';
...
export interface AvatarsOptions {
     ...
     * the image) or a component.
     */
    assistant?: string | ComponentType<{
        className: string;
    }>;
}
export type ButtonTheme = 'purple';
export type MenuIconId = 'book' | 'chat' | 'discord' | 'magnifying-glass' | 'newspaper' | 'sparkles';
